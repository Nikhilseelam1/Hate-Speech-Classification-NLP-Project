...
class DataIngestionConfig:
    def __init__(self):
        self.GITHUB_ZIP_URL = "https://github.com/Nikhilseelam1/dataset/raw/main/dataset%20(1).zip"
        ...
        self.DATA_ARTIFACTS_DIR = os.path.join(
            self.DATA_INGESTION_ARTIFACTS_DIR,
            DATA_INGESTION_IMBALANCE_DATA_DIR
        )

        self.NEW_DATA_ARTIFACTS_DIR = os.path.join(
            self.DATA_INGESTION_ARTIFACTS_DIR,
